...
`docs/getting-started.md`, `docs/history/M4_FINAL_REPORT.md`. No `relay-core` changes were required (one small,
...
adopted profiles on a disposable project. Details: `docs/herdr-integration.md`, `docs/history/M3_FINAL_REPORT.md`.
...
- **M3 (approved): Herdr integration — thin plugin, no relay-core changes.**
  ...
  - Full account: `docs/herdr-integration.md`, `docs/history/M3_FINAL_REPORT.md`.
